  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center bg-gray-100 px-4">
      <div className="bg-white px-6 py-8 md:px-10 md:py-10 rounded-3xl border border-gray-200 shadow-lg w-full max-w-md">
        {/* Title */}
        <h2 className="text-3xl md:text-5xl font-bold text-center">Register your company</h2>

        <div className="mt-6">
          {/* Company Name */}
          <div className="mb-4">
            <label className="text-sm md:text-lg font-medium" htmlFor="companyName">
              Company Name
            </label>
            <input
              id="companyName"
          ...
          {/* Address */}
          <div className="mb-4">
            <label className="text-sm md:text-lg font-medium" htmlFor="address">
              Address
            </label>
            <input
              id="address"
          ...
          <div className="mb-4">
            <label className="text-sm md:text-lg font-medium" htmlFor="establishmentDate">
              Date of Establishment
            </label>
            <input
